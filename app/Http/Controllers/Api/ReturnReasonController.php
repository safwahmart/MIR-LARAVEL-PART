...
class ReturnReasonController extends Controller
{
    ...
    {
        $highlightTypes = ReturnReason::all();
    ...
    public function store(Request $request)
    {
        ...
        $brands = ReturnReason::create($request->all());
     ...
     *
     * @param  \App\Models\ReturnReason  $highlightType
     * @return \Illuminate\Http\Response
     */
    public function show(ReturnReason $highlightType)
    {
        $highlightType = ReturnReason::find($highlightType->id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ReturnReason $highlightType)
    {
        //
    }
    ...
    {
        $highlightType = ReturnReason::find($id);
        $validator = Validator::make($request->all(), [
            'title' => 'required'
        ]);
